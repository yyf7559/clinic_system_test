    ...
    <script>
        $(function () {
            ...
            function medicineList(name,prescriptionTypeId) {
                $.ajax({
                    url:'inmedicine?medicineVO.prescriptionTypeId='+prescriptionTypeId+'&medicineVO.name='+name,
                    type:'post',
                    success:function (data) {
                        ...
                        for (var i = 0;i<data.length;i++){
                            ...
                            "<td>"+data[i].id+"</td>"+
                            "<td>"+data[i].medicineno+"</td>"+
                            "<td>"+data[i].medicinename+"</td>"+
                            "<td>"+data[i].medicinesize+"</td>"+
                            "<td>"+data[i].prescriptiontype.tname+"</td>"+
                            "<td>"+data[i].purchaseprice+"</td>"+
                            "<td>"+data[i].price+"</td>"+
                            "<td>"+data[i].manufacturer.manufacturername+"</td>"+
                            "</tr>";
                            html += obj;
                        }
                        $("#tbody").html(html);
                ...
                <li>
                    ...
                    <select class="form-control" style="width: 150px;" name="inStock.manufacturerId">
                        <s:iterator value="#request.manufacturerList" var="manufacturer">
                            <option value="${manufacturer.id}" <s:if test="#request.inStock.manufacturerId == #manufacturer.id">selected</s:if>>${manufacturer.manufacturername}</option>
                        </s:iterator>
                    </select>
                </li>
                <li>
    ...
    <s:else>
        <s:iterator value="#request.inStockMedicineList" var="inStockMedicine">
            <tr>
                ...
                <td>${inStockMedicine.medicine.manufacturer.manufacturername}</td>
                ...
                <td class="retailPrice">${inStockMedicine.medicine.price}</td>
