...
<button style="float: right" id="add-btn" class="btn btn-primary" onclick="location.href='http://localhost:8080/medicine/toaddoutstock'" data-loading-text="Loading..."
        type="button">新增入库
</button>
<div align="center">
        ...
        <tr>
            ...
            <td>
                <s:if test="#g.statusid==2||#g.statusid==1">
                    <button type="button"onclick="location.href='http://localhost:8080/medicine/outstockdetail?outstockVo.geo=${g.id}'" class="btn btn-primary btn-sm ">查看</button>|
                </s:if>
                <s:if test="#g.statusid==3">
                    <button type="button" onclick="location.href='http://localhost:8080/medicine/toupdateoutstock?outstockVo.geo=${g.id}'" class="btn btn-primary btn-sm">编辑</button>|
                </s:if>
                <button type="button" onclick="location.href='http://localhost:8080/medicine/deloutstock?outstockVo.geo=${g.id}'" class="btn btn-primary btn-sm ">删除</button> |
                <s:if test="#g.statusid==1||#g.statusid==2">
                    <button type="button" onclick="location.href='http://localhost:8080/medicine/addagainoutstock?outstockVo.geo=${g.id}'" class="btn btn-primary btn-sm ">再次出库</button>
                </s:if>
            </td>
        </tr>
    </s:iterator>
