...
<nav class="navbar navbar-default navbar-static-top" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            <a class="navbar-brand" href="#">出库管理</a>
        </div>
        <div>
    ...
    <table class="table table-hover">
        ...
        <s:iterator value="#outstockmedicine" var="g">
            <tr class="tr">
                ...
                <td><input type='text' value="${count}" class='form-control' name='count' style='width: 130px;display: inline-block'/></td>
                <td><input type='text' class='form-control' style='width: 130px;display: inline-block' disabled value='g/袋'/></td>
                <td><input type='text' value="${medicine.purchaseprice}" class='form-control' style='width: 130px;display: inline-block' disabled value=''/></td>
                <td><input type='text' value="${medicine.price}" style='width: 130px;display: inline-block' class='form-control' disabled value=''/></td>
                <td><input class='form-control' value="${lotnumber}" style='width: 120px;display: inline-block' name=''/></td>
                <td><input type='date' value="${expirationdate}" class='form-control' style='width: 120px;display: inline-block' name=''/></td>
                ...
                <table class="table table-hover">
                    ...
                    <s:iterator value="#medicines" var="g">
                        <tr>
                            ...
                            <td><s:property value="#g.prescriptiontype.tname"/></td>
                            <td><s:property value="#g.medicinesize"/></td>
                            <td><s:property value="#g.manufacturer.manufacturername"/> </td>
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        for (var i=0;i<data.length;i++){
                            tr+="<tr><td><input type=\"checkbox\" name=\"check\"/></td><td>"+data[i].id+"</td><td>"+data[i].medicineno+"</td><td>"+data[i].medicinename+"</td><td>"+data[i].prescriptiontype.tname+"</td><td>"
                                +data[i].medicinesize+"</td><td>"+data[i].manufacturer.manufacturername+"</td><td>"+data[i].stock+"</td><td>"+data[i].purchaseprice+"</td><td>"+data[i].price+"</td></tr>"
        ...
        data:
            ...
            success: function (data) {
                ...
                $(".tr").each(function (i) {
                    ...
                    alert("提交成功！");
                    location.href='http://localhost:8080/medicine/outstock';
            }
    });
