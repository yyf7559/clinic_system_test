    ...
    <s:iterator value="#inventoryList" var="g">
        <tr>
            ...
            <td>
                ...
                <button type="button"onclick="location.href='http://localhost:8080/medicine/toinventorydetailbyinfo?inventoryVo.status=${g.status}&inventoryVo.geo=${g.id}'" class="btn btn-primary btn-sm ">查看</button>
                <s:if test="#g.status==2">|<button type="button" onclick="location.href='http://localhost:8080/medicine/delinventory?inventoryVo.geo=${g.id}'" class="btn btn-primary btn-sm ">删除</button></s:if>
            </td>
        </tr>
    </s:iterator>
    </tbody>
